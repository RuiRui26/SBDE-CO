    ...
    <section class="apply-section">
        <div class="apply-container">
            ...
            <div class="apply-box">
                ...
                <h2>Lost Document</h2>
                    <a href="appoint_lost.html" class="apply-btn">Add Client</a>
            </div>
            ...
            <div class="apply-box">
                ...
                <a href="register_lto.html" class="apply-btn">Add Client</a>
            </div>
            ...
            <div class="apply-box">
                ...
                <h2>Insurance</h2>
                    <a href="register_insurance.html" class="apply-btn">Add Client</a>
            </div>
        </div>
    </section>
</body>
